...
procedure TPNGPayload.WriteChunk(var F: File; Index: Integer);
var
  t: LongWord;
begin
...
constructor TPNGPayload.Create(InputFile: ansistring);
var
  f: File;
  pos, c: LongWord;
begin
...
destructor TPNGPayload.Destroy;
begin
...
procedure TPNGPayload.Rebuild(OutputFile, Comment: ansistring);
var
  f: File;
  i: Integer;
  t: LongWord;
